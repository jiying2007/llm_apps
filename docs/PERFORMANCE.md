...
CI generates a 32 MiB UTF-8 fixture and validates cross-buffer search, random reads, eight concurrent readers, malformed UTF-8 rejection and repeated handle lifecycle. Android CI compiles the Compose UI and instrumentation tests in addition to Debug/Release lint/build.

Device 10/100/300 MiB timing, jank and memory results remain release/device evidence and are recorded in `DEVICE_MATRIX.md`.
