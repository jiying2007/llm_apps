...
require_literal "$screen" '{ controlsVisibility.value = !controlsVisibility.value }' 'current-state controls toggle callback'
...
require_literal "$screen" 'snapshotFlow { controlsVisible }' 'auto-hide controls visibility source'
