...
require_literal "$screen" 'settleContinuousPosition(scrollModel.offsetPx.roundToInt(), auto = false)' 'manual continuous settle' require_literal "$screen" 'AUTO_SCROLL_POSITION_SAMPLE_NS = 250_000_000L' 'coarse auto-scroll position cadence'
...
require_literal "$screen" 'ReaderTopBarV3(book.name, currentChapter' 'top bar minimal state'
